...
bench: src/*.cr src/**/*.cr benchmark/bench.cr http_parser.o
...
example: src/*.cr src/**/*.cr examples/example.cr http_parser.o
...
.PHONY: clean
clean:
	rm -f example bench bench_cpp bench_native *.o *.so
